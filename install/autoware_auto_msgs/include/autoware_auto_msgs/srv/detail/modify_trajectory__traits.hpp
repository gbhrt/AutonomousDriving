...
inline void to_yaml(
  const autoware_auto_msgs::srv::ModifyTrajectory_Request & msg,
...
inline std::string to_yaml(const autoware_auto_msgs::srv::ModifyTrajectory_Request & msg)
{
...
inline void to_yaml(
  const autoware_auto_msgs::srv::ModifyTrajectory_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  // member: modified_trajectory
  {
...
inline std::string to_yaml(const autoware_auto_msgs::srv::ModifyTrajectory_Response & msg)
{
  std::ostringstream out;
  to_yaml(msg, out);
  return out.str();
