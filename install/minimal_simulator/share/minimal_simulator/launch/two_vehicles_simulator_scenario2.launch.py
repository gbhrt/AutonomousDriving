...
def generate_launch_description():
    ...
    for i in range(1,vehicle_num+1):
        vehicle_nodes.append(
            Node(
                ...
                name="minimal_simulator_node",
                output="screen",
                parameters=[os.path.join(minimal_simulator_pkg_prefix, "param/vehicles/vehicle"+str(i)+".param.yaml")
                ],
                remappings=[
    ...
    for i in range(1,vehicle_num+1):
        traj_file_name = get_share_file('file_trajectory_planner', 'param/trajectories/Scenario_2/traj'+str(i)+'.txt')
