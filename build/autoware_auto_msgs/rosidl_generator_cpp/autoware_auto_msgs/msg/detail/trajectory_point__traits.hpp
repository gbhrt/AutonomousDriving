...
inline void to_yaml(
  const autoware_auto_msgs::msg::TrajectoryPoint & msg,
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: heading
  {
    ...
    out << "heading:\n";
    to_yaml(msg.heading, out, indentation + 2);
  }
...
inline std::string to_yaml(const autoware_auto_msgs::msg::TrajectoryPoint & msg)
{
