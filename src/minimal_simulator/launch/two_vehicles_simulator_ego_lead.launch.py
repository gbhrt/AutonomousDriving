...
def generate_launch_description():
    ...
    minimal_simulator = Node(
        ...
        parameters=[os.path.join(minimal_simulator_pkg_prefix, "param/vehicles/ego_vehicle.param.yaml")],#ego_lead
        remappings=[
    ...
    vehicle_num = 1 #int(launch.substitutions.LaunchConfiguration('vehicle_num'))
    ...
    for i in range(1,vehicle_num+1):
        vehicle_nodes.append(
            Node(
                ...
                name="minimal_simulator_node",
                output="screen",
                parameters=[os.path.join(minimal_simulator_pkg_prefix, "param/vehicles/vehicle"+str(i)+".param.yaml")#ego_lead
                ],
                remappings=[
    ...
    for i in range(1,vehicle_num+1):
        traj_file_name = get_share_file('file_trajectory_planner', 'param/trajectories/Scenario_3/full_trajectory_TUM.txt' )#
